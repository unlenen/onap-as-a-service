...
public enum OnapRequest {
 ...
 /*CLOUD Complex*/
    ...
    CLOUD_AVAILABILITY_ZONE_CREATE(HttpCallType.PUT, OnapModule.AAI, "/cloud-infrastructure/cloud-regions/cloud-region/${" + OnapRequestParameters.CLOUD_OWNER + "}/${" + OnapRequestParameters.CLOUD_REGION + "}/availability-zones/availability-zone/${" + OnapRequestParameters.CLOUD_AVAILABILITY_ZONE + "}", 201, HttpResponseType.STRING, "payloads/cloud/az_create.json", "application/json"),
    /*CLOUD Other*/
    ...
    CLOUD_K8S_INST_DETAIL(HttpCallType.GET, OnapModule.MULTICLOUD_K8S, "/v1/instance/${" + OnapRequestParameters.CLOUD_HELM_INST_ID + "}", 200, HttpResponseType.JSONObject),
    /*BUSINESS*/
    /*BUSINESS Customers*/
    ...
    SDC_SERVICE_MODEL_DISTRIBUTE_LIST(HttpCallType.GET, OnapModule.SDC_FeProxy, "/rest/v1/catalog/services/${" + OnapRequestParameters.DESIGN_SERVICE_MODEL_UUID + "}/distribution", 200, HttpResponseType.JSONObject),
    SDC_SERVICE_MODEL_DISTRIBUTE_DETAIL(HttpCallType.GET, OnapModule.SDC_FeProxy, "/rest/v1/catalog/services/distribution/${" + OnapRequestParameters.DESIGN_SERVICE_MODEL_DISTRIBUTION_ID + "}", 200, HttpResponseType.JSONObject),
    ...
    AAI_SERVICE_MODEL_SUBSCRIPTION_CREATE(HttpCallType.PUT, OnapModule.AAI, "/service-design-and-creation/services/service/${" + OnapRequestParameters.DESIGN_SERVICE_MODEL_InvariantUUID + "}", 201, HttpResponseType.STRING, "payloads/business/subscription/serviceCreate.json", "application/json"),
    /*RUNTIME*/
    ...
    RUNTIME_SERVICE_INSTANCE_DELETE(HttpCallType.POST, OnapModule.SO, "/infra/serviceInstantiation/v7/serviceInstances/${" + OnapRequestParameters.RUNTIME_SERVICE_INSTANCE_ID + "}", 202, HttpResponseType.JSONObject, "payloads/runtime/serviceInstance/delete.json", "application/json"),
    ...
    RUNTIME_VNF_DELETE(HttpCallType.DELETE, OnapModule.SO, "/infra/serviceInstantiation/v7/serviceInstances/${" + OnapRequestParameters.RUNTIME_SERVICE_INSTANCE_ID + "}/vnfs/${" + OnapRequestParameters.RUNTIME_VNF_ID + "}", 202, HttpResponseType.JSONObject, "payloads/runtime/vnf/delete.json", "application/json"),
    ...
    RUNTIME_VFMODULE_CREATE(HttpCallType.POST, OnapModule.SO, "/infra/serviceInstantiation/v7/serviceInstances/${" + OnapRequestParameters.RUNTIME_SERVICE_INSTANCE_ID + "}/vnfs/${" + OnapRequestParameters.RUNTIME_VNF_ID + "}/vfModules", 202, HttpResponseType.JSONObject, "payloads/runtime/vfModule/create.json", "application/json"),
    RUNTIME_VFMODULE_DELETE(HttpCallType.DELETE, OnapModule.SO, "/infra/serviceInstantiation/v7/serviceInstances/${" + OnapRequestParameters.RUNTIME_SERVICE_INSTANCE_ID + "}/vnfs/${" + OnapRequestParameters.RUNTIME_VNF_ID + "}/vfModules/${" + OnapRequestParameters.RUNTIME_VF_MODULE_ID + "}", 202, HttpResponseType.JSONObject, "payloads/runtime/vfModule/delete.json", "application/json"),
