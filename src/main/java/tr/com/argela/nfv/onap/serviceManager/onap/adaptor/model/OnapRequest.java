...
public enum OnapRequest {
    ...
    BUSINESS_CUSTOMER_SUBSCRIPTION_CREATE(HttpCallType.PUT, OnapModule.AAI, "/business/customers/customer/${" + OnapRequestParameters.BUSINESS_CUSTOMER_ID + "}/service-subscriptions/service-subscription/${" + OnapRequestParameters.DESIGN_SERVICE_MODEL_UNIQUE_ID + "}", 201, HttpResponseType.STRING, "payloads/business/subscription/customerToService.json", "application/json"),
    BUSINESS_CUSTOMER_TENANT_SUBSCRIPTION_CREATE(HttpCallType.PUT, OnapModule.AAI, "/business/customers/customer/${" + OnapRequestParameters.BUSINESS_CUSTOMER_ID + "}/service-subscriptions/service-subscription/${" + OnapRequestParameters.DESIGN_SERVICE_MODEL_UNIQUE_ID + "}/relationship-list/relationship", 200, HttpResponseType.STRING, "payloads/business/subscription/customerToTenant.json", "application/json"),
